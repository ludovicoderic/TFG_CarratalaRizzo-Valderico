...
message(FATAL_ERROR "Could not find messages which '/home/ludo/catkin_ws/src/slam_gmapping/my_msgs/msg/TreeInfo.msg' depends on. Did you forget to specify generate_messages(DEPENDENCIES ...)?
Cannot locate message [treeVariables]: unknown package [msg] on search path [{'my_msgs': ['/home/ludo/catkin_ws/src/slam_gmapping/my_msgs/msg']}]")
message(STATUS "my_msgs: 2 messages, 0 services")

set(MSG_I_FLAGS "-Imy_msgs:/home/ludo/catkin_ws/src/slam_gmapping/my_msgs/msg")
...
get_filename_component(_filename "/home/ludo/catkin_ws/src/slam_gmapping/my_msgs/msg/TreeVariables.msg" NAME_WE)
add_custom_target(_my_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "my_msgs" "/home/ludo/catkin_ws/src/slam_gmapping/my_msgs/msg/TreeVariables.msg" ""
)
